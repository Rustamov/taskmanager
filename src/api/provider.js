...
export default class Provider {
  ...
  createTask(task) {
    ...
    // На случай создания данных мы должны сами создать id
    // Иначе наша модель будет не полной что может привнести баги
